...
app.post('/register', (req, res) => {
    ...
    const result = dataService.register(req.body.accno, req.body.uname, req.body.password)
...
app.post('/deposit', jwtMiddleware,(req, res) => {
    console.log(req.body);
    // req,
    const result = dataService.deposit( req.body.acno, req.body.pass, req.body.amt)
    res.status(result.statusCode).send(result)
})
